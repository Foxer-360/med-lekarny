...
var PromotionPreviews = function (props) {
    ...
    return (React.createElement("div", { className: 'promotions' },
        React.createElement("div", { className: 'container' },
            React.createElement(AliceCarousel, { responsive: responsive, dotsDisabled: true, buttonsDisabled: true, autoPlay: autoPlay, mouseDragEnabled: true, autoPlayInterval: 6000, stopAutoPlayOnHover: true }, promotionPreviews && promotionPreviews.map(function (item, i) {
