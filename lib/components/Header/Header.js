  ...
  Header.prototype.render = function () {
    ...
    return React.createElement(ComposedQuery, null, function (_a) {
      ...
      return React.createElement("header", {
        ...
        src: context.languageData.code === 'cs' ? '/assets/mediconLekarny/images/mediconLekarnyLogo.png' : '/assets/mediconLekarny/images/logo-sr.svg',
        ...
        return React.createElement("li", {
          key: i,
          className: context.pageData.name === navItem.name ? 'activePage' : ''
        }, React.createElement(_Link.default, __assign({}, navItem.url), navItem.name || navItem.title));
      })), React.createElement(_Hamburger.default, {
        active: _this.state.menuActive,
        onClick: _this.toggleMenu
      })))), _this.props.data.showTriangle && React.createElement("div", {
