...
export default function ViewsAboutUsElement(props) {
    ...
    return (React.createElement("div", { className: "viewsAboutUs__list__element" },
        (image && React.createElement(Media, { type: 'image', data: image })) || (React.createElement("img", { src: '/assets/mediconLekarny/images/review-aboutus-1.jpg', alt: "review about us" })),
