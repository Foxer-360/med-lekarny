...
var CookiePopup = function (_a) {
    ...
    function renderBanner() {
        return (React.createElement("div", { className: "cookiePopup" },
            React.createElement("img", { src: "/assets/mediconLekarny/images/cookie.svg", alt: "cookies" }),
    ...
    return (React.createElement(react_cookie_consent_1.default, { expires: 365, location: 'bottom', cookieName: 'MediconLekarnyCookies', acceptOnScroll: false, buttonText: lang === 'cs' ? 'OK' : 'Got it!', acceptOnScrollPercentage: 100, style: { background: '#efefef', color: '#3c3c3b' }, buttonStyle: { background: '#3eac49', color: '#ffffff', fontSize: '13px' } }, renderBanner()));
};
