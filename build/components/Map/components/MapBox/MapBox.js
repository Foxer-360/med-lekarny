...
var MapBox = function (props) {
    return (React.createElement("div", { className: 'mapBox' },
        React.createElement("img", { src: '/assets/mediconLekarny/images/mapbox.png' }),
        ...
        React.createElement("div", { className: 'mapBox__contacts' },
            ...
            React.createElement("div", { className: 'mapBox__contacts__item' },
                React.createElement("img", { src: '/assets/mediconLekarny/images/phone.png' }),
                React.createElement("div", null,
                    React.createElement("p", null, "+420 266 006 211")))),
        React.createElement("div", { className: 'mapBox__buttons' },
            React.createElement(Button, { classes: "btn--small btn--greenBkg", noArrow: true }, "ambulance"),
            React.createElement(Button, { classes: "btn--small btn--greenBorder" }, "kuddy k nam"))));
};
