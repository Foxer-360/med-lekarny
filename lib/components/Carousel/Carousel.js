...
function (_super) {
  ...
  function Carousel(props) {
    ...
    _this.slideWidth = function () {
      if (document.querySelector('.slider__slide')) {
        ...
        var iFrameWidth = document.querySelector('iframe').clientWidth; // fix for desktop backoffice: 75% width because '.slider__slide' 75% too (Not whole Carousel)
      ...
      data.map(function (slide, i) {
        if (slide.image) {
          result.push(React.createElement("div", {
            ...
            id: 'slider__slide'
          }, React.createElement(_Link["default"], __assign({}, slide.url), React.createElement(_Media["default"], {
            type: 'image',
            data: slide.image
          }))));
        }
  ...
  Carousel.prototype.renderSlider = function (data) {
    ...
    }, this.renderSlides(data)), this.state.showArrows ? React.createElement(React.Fragment, null, React.createElement(_LeftArrow["default"], {
      goToPrevSlide: this.goToPrevSlide
    }), React.createElement(_RightArrow["default"], {
      goToNextSlide: this.goToNextSlide
    })) : '', this.state.showDots && this.state.slides.length > 0 ? React.createElement(_Dots["default"], {
      goTo: this.goTo,
  ...
  Carousel.prototype.render = function () {
    ...
    return React.createElement(_List["default"], {
      ...
      }, _this.renderSlider(data)), React.createElement("div", {
