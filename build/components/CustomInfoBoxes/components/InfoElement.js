...
function InfoElement(props) {
    ...
    return (React.createElement(Link_1.default, __assign({}, link, { className: 'custom-info-boxes__list__element', style: { backgroundImage: image && "url(" + getImageUrl_1.default(image) + ")" } }),
