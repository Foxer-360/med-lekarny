        ...
        React.createElement("div", { className: 'container' },
            ...
            React.createElement("div", { className: 'pharmacie-info__content' },
                React.createElement("div", { className: 'pharmacie-info__content__item' },
                    React.createElement("img", { src: '/assets/medicon/images/phoneIcon.svg', alt: "phone nubmer" }),
                    phone && React.createElement("p", null, phone)),
                React.createElement("div", { className: 'pharmacie-info__content__item' },
                    React.createElement("img", { src: '/assets/medicon/images/geoIcon.svg', alt: "address" }),
                    geo && React.createElement("p", null, geo)),
                React.createElement("div", { className: 'pharmacie-info__content__item' },
                    React.createElement("img", { src: '/assets/medicon/images/officeHours.svg', alt: "office hours" }),
