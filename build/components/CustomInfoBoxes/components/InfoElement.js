...
function InfoElement(props) {
    ...
    return (React.createElement("div", { className: 'custom-info-boxes__list__element col-sm-12 col-md-6 col-xl-4', style: { backgroundImage: image && "url(" + getImgUrl_1.default(image) + ")" } },
