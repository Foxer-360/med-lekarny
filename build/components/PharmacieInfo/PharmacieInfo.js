        ...
        React.createElement("div", { className: 'container' },
            ...
            React.createElement("div", { className: 'pharmacie-info__content' },
                React.createElement("div", { className: 'pharmacie-info__content__item' },
                    React.createElement("img", { src: '/assets/mediconLekarny/images/phone.png', alt: "phone nubmer" }),
                    phone && React.createElement("p", null, phone)),
                React.createElement("div", { className: 'pharmacie-info__content__item' },
                    React.createElement("img", { src: '/assets/mediconLekarny/images/geo.png', alt: "address" }),
                    geo && React.createElement("p", null, geo)),
                React.createElement("div", { className: 'pharmacie-info__content__item' },
                    React.createElement("img", { src: '/assets/mediconLekarny/images/officeHours.png', alt: "office hours" }),
