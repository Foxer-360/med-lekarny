      ...
      <div className={'container'}>
        <div className={'grid contact-info__grid'}>
          ...
          <div className={'grid contact-info__grid__element'}>
            <img src={'/assets/mediconLekarny/images/contact-info-1.png'} alt="address"/>
            <div>
              {address && <ReactMarkdown source={address} />}
            </div>
          </div>
          <div className={'grid contact-info__grid__element'}>
            <img src={'/assets/mediconLekarny/images/contact-info-2.png'} alt="phone number"/>
            <div>
              {phones && <ReactMarkdown source={phones} />}
            </div>
          </div>
          <div className={'grid contact-info__grid__element'}>
            <img src={'/assets/mediconLekarny/images/contact-info-3.png'} alt="e-mail"/>
            <div>
              {emails && <ReactMarkdown source={emails} />}
            </div>
          </div>
          <div className={'grid contact-info__grid__element'}>
            <img src={'/assets/mediconLekarny/images/contact-info-4.png'} alt="ICO and DIC"/>
            <div>
