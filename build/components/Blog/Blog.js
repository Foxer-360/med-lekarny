...
var Blog = /** @class */ (function (_super) {
    ...
    Blog.prototype.mapArticleToContent = function (article, languageCode, index) {
        ...
        if (blogArticleComponentData) {
            var _a = findFirst(content.content, 'content', { name: 'BlogArticle' }).data, text = _a.text, image = _a.image, name_1 = _a.title;
            return (React.createElement(BlogCard, { id: article.id, title: name_1, text: text.slice(0, 35) + " ..", key: index, color: index % 2 === 0 ? '#3eac49' : '#2473ba', img: image, special: false }));
        }
        return React.createElement("div", null);
    };
    return Blog;
