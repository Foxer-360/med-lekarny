            ...
            slides.map(function (slide, i) {
                if (slide.image) {
                    if (slide.url) {
                        ...
                        images.push(React.createElement("div", null,
                            React.createElement(Media, { key: i, type: 'image', data: slide.image })));
                    }
                }
            });
    ...
    Carousel.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'carousel' },
            ...
            React.createElement("div", { className: 'carousel__images', style: displayOnTop ? {} : { gridRow: 'auto' } },
                React.createElement(AliceCarousel, { autoPlay: true, dotsDisabled: true, buttonsDisabled: true, autoPlayInterval: 1000000, items: this.state.galleryItems, onSlideChanged: function (e) {
