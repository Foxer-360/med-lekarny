...
var MiniBoxes = function (props) {
    ...
    return (React.createElement("div", { className: 'mini-boxes' },
        React.createElement("div", { className: "container" },
            ...
            React.createElement("div", { className: 'mini-boxes__list grid' }, miniBoxes && miniBoxes.map(function (box, i) {
                return (React.createElement(Link, { key: i, url: box.url && box.url, className: 'mini-boxes__list__item', style: { backgroundImage: box.image && "url(" + getImageUrl(box.image) + ")" } },
