...
function (_super) {
  ...
  Hero.prototype.render = function () {
    var _a = this.props.data,
        ...
        text = _a.text,
        image = _a.image,
        displayBlackOverlay = _a.displayBlackOverlay,
        displayWhiteOverlay = _a.displayWhiteOverlay,
    ...
    }, displayBlackOverlay && React.createElement("div", {
      style: opacity ? {
        opacity: opacity
      } : {},
      className: 'hero__blackOverlay'
    }), displayWhiteOverlay && React.createElement("div", {
      style: opacity ? {
        opacity: opacity
      } : {},
      className: 'hero__whiteOverlay'
